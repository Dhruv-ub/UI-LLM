...
export default function AuthView({ onBackClick, onAuthSuccess }) {
 ...
 <span className="font-headline-md text-headline-md text-primary font-bold tracking-tight">HWP_AI</span>
 </div>
 ...
 {isSignUp ? 'Get started with HWP_AI today' : 'Sign in to your dashboard to continue'}
 </p>
 </div>
